    ...
    <section className="py-24 bg-[#1a1025] px-6 md:px-8 lg:px-12">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-24">
          <Link href="/collections?gender=male" className="relative group overflow-hidden rounded-xl w-full max-w-[350px] md:max-w-[400px] aspect-[4/5] md:aspect-[2/3] shadow-2xl">
            <img 
              src={maleImg} 
              alt="Male Fashion" 
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h2 className="text-white text-6xl md:text-7xl font-heading font-black tracking-tighter uppercase italic drop-shadow-2xl">
                MALE
              </h2>
            </div>
          ...
          <Link href="/collections?gender=female" className="relative group overflow-hidden rounded-xl w-full max-w-[350px] md:max-w-[400px] aspect-[4/5] md:aspect-[2/3] shadow-2xl">
            <img 
              src={femaleImg} 
              alt="Female Fashion" 
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
